...
import io.abikussudo.sagernet.bg.Executable
import io.abikussudo.sagernet.database.*
import io.abikussudo.sagernet.database.preference.KeyValuePair
import io.abikussudo.sagernet.database.preference.PublicDatabase
import io.abikussudo.sagernet.databinding.LayoutBackupBinding
import io.abikussudo.sagernet.databinding.LayoutImportBinding
import io.abikussudo.sagernet.databinding.LayoutProgressBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.actionExport.setOnClickListener {
            runOnDefaultDispatcher {
                ...
                onMainDispatcher {
                    startFilesForResult(
                        exportSettings, "worda_backup_${Date().toLocaleString()}.json"
                    )
                }
            }
        }
        ...
        binding.actionShare.setOnClickListener {
            runOnDefaultDispatcher {
                ...
                app.cacheDir.mkdirs()
                val cacheFile = File(
                    app.cacheDir, "worda_backup_${Date().toLocaleString()}.json"
                )
