...
import io.abikussudo.sagernet.databinding.LayoutAboutBinding
                    ...
                    MaterialAboutCard.Builder()
                            ...
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/AbikusSudo/WorDaForAndroid/releases"
                                    )
                                }
                                .build())
                        .addItem(
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://worda.2bd.net/index_docs/#donate"
                                    )
                                }
                                .build())
                        .apply {
                    ...
                    MaterialAboutCard.Builder()
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/AbikusSudo/WorDaForAndroid"
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val response = client.newRequest().apply {
                        if (checkPreview) {
                            setURL("https://api.github.com/repos/AbikusSudo/WorDaForAndroid/releases/tags/preview")
                        } else {
                            setURL("https://api.github.com/repos/AbikusSudo/WorDaForAndroid/releases/latest")
                        }
                    }.execute()
