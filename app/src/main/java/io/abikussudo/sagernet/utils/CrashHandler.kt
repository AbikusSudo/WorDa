package io.abikussudo.sagernet.utils
...
import io.abikussudo.sagernet.ui.BlankActivity
...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "WorDa for Android ${SagerNet.appVersionNameForDisplay} (${BuildConfig.VERSION_CODE})\n"
